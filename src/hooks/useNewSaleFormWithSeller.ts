...
export function useNewSaleFormWithSeller() {
  ...
  const handleSellerChange = (sellerId: string, sellerName: string, isVirtual: boolean) => {
    setFormData(prev => ({
      ...prev,
      assignedSellerId: sellerId,
      assignedSellerName: sellerName,
      isVirtualSeller: isVirtual
    }));
  };
